...
#          {'train.model':'@annealed_vae','annealed_vae.c_max':25, 'annealed_vae.iteration_threshold':30000,'annealed_vae.gamma':1000},
#          {'train.model':'@vae'},
#          {'train.model':'@cascade_vae_c', 'model.stage_steps':6000}]
model = [{'train.model': '@annealed_vae', 'annealed_vae.c_max': 25, 'annealed_vae.iteration_threshold': 30000,
          'annealed_vae.gamma': 100},
         {'train.model': '@annealed_vae', 'annealed_vae.c_max': 15, 'annealed_vae.iteration_threshold': 30000,
          'annealed_vae.gamma': 1000},
         {'train.model': '@annealed_vae', 'annealed_vae.c_max': 25, 'annealed_vae.iteration_threshold': 50000,
          'annealed_vae.gamma': 1000}, ]
...
for i, run_args in enumerate(runs):
    ...
    ret = os.system("dlib_annealed_comparison " + args_str)
    if ret != 0:
        exit(ret)
