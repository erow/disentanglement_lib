...
#     """Generate a DataSet from ground_truth data."""
#
#     def generator():
...
#
#     return torch.data.Dataset.from_generator(
#         generator, torch.float32, output_shapes=ground_truth_data.observation_shape)
